...
public class Robot extends TimedRobot {
 ...
 @Override
  public void robotInit() {
    ...
    limiter = new SlewRateLimiter(0.33);
    getTelem();
   }
  ...
  public void teleopPeriodic() {
    ...
    dt_main.tankDrive(-errorAdjust, errorAdjust);
      ...
      dt_main.tankDrive(limiter.calculate(control1.getLeftY()), limiter.calculate(control1.getRightY()));
    }
  }
  ...
  public void getTelem() {    
    ...
    SmartDashboard.putNumber("Error for Auton PID", error);
